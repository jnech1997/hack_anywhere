...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GhostControl",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12GhostControl11AppDelegate")
...
SWIFT_CLASS("_TtC12GhostControl14ViewController")
@interface ViewController : NSViewController <AVCaptureVideoDataOutputSampleBufferDelegate, NSSpeechRecognizerDelegate>
@property (nonatomic) NSInteger num_blink_right;
@property (nonatomic) NSInteger num_blink_left;
@property (nonatomic, strong) IBOutlet NSView * _Null_unspecified previewView;
- (void)make_space;
- (void)move_left;
- (void)move_right;
